...
// Color Grenade.
//=============================================================================
class Color_Grenade extends Projectile;

#exec MESH IMPORT MESH=C_UTGrenade ANIVFILE=MODELS\UTGrenade_a.3D DATAFILE=MODELS\UTGrenade_d.3D X=0 Y=0 Z=0
#exec MESH ORIGIN MESH=C_UTGrenade X=0 Y=0 Z=0 YAW=-64

#exec MESH SEQUENCE MESH=C_UTGrenade SEQ=All       STARTFRAME=0   NUMFRAMES=1
#exec MESH SEQUENCE MESH=C_UTGrenade SEQ=WingIn    STARTFRAME=0   NUMFRAMES=1

#exec MESHMAP SCALE MESHMAP=C_UTGrenade X=2.2 Y=2.2 Z=4.3 YAW=128
#exec MESHMAP SETTEXTURE MESHMAP=C_UTGrenade NUM=1 TEXTURE=Botpack.FlakGlow.fglow_a00
...
defaultproperties
{
     ...
     AnimSequence=WingIn
     Mesh=LodMesh'Rainbow.C_UTGrenade'
     DrawScale=0.020000
     AmbientGlow=64
     bUnlit=True
     bBounce=True
