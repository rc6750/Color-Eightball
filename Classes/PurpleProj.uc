//=============================================================================
// PurpleProj.
// Shockwave only - good for pushing other projectiles and players around
//=============================================================================
class PurpleProj expands Projectile;
...
function Explode(vector HitLocation, vector HitNormal)
	{
		...
		spawn(class'Rainbow.PurpleShockWave',,,HitLocation+ HitNormal*16);	
...
defaultproperties
{
     ...
     Texture=Texture'Rainbow.PurpleASMDAlt.PurpleASMDAlt_a00'
     DrawScale=0.400000
     bUnlit=True
